...
export const placeWord = (word) => {
    ...
    wordLoop: for (const letter of wordUppercase) {
        ...
        while (colIndex < initialTable[0].length - letterMaxWidth + 1) {
            ...
            rowLoop: for (let rowIndex = 0; rowIndex < initialTable.length - letterDefinition.length + 1; rowIndex++) {
